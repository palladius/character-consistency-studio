...
### Added
- Added a "Requested Ratio" field to the image details view. This stores the aspect ratio selected by the user at generation time, allowing for easier debugging by comparing the requested ratio to the final image's dimensions.
